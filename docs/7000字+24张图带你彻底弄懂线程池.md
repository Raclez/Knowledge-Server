![](https://ask.qcloudimg.com/http-save/yehe-9887858/eab3b72700355569f6321b5838d702e5.png)
...
![](https://ask.qcloudimg.com/http-save/yehe-9887858/d9bb3eacc4f646212b23dbcb55e1e7b1.png)
...
![](https://ask.qcloudimg.com/http-save/yehe-9887858/1323f4f5327018aa6b6a84b642b007df.png)
...
![](https://ask.qcloudimg.com/http-save/yehe-9887858/a2c6df558caaa8880610cc197309ff7b.png)

当任务执行完之后，线程不会退出，而是会去从阻塞队列中获取任务，如下图

![](https://ask.qcloudimg.com/http-save/yehe-9887858/c776aff99416b9041be4cad4cd2259d6.png)
...
![](https://ask.qcloudimg.com/http-save/yehe-9887858/1ffe3c04e2b3181449fa07261ce5877d.png)
...
![](https://ask.qcloudimg.com/http-save/yehe-9887858/22ed9797cde5ea2c340b0222f592645b.png)
...
![](https://ask.qcloudimg.com/http-save/yehe-9887858/3aa98f5f252e7f6e76011c710eefa251.jpeg)
...
线程池创建的时候，如果不指定拒绝策略就默认是AbortPolicy策略。当然，你也可以自己实现RejectedExecutionHandler接口，比如将任务存在[数据库](https://cloud.tencent.com/product/tencentdb-catalog?from_column=20065&from=20065)或者缓存中，这样就数据库或者缓存中获取到被拒绝掉的任务了。
...
![](https://ask.qcloudimg.com/http-save/yehe-9887858/9f47805bf74145a62fe36506f8d0292f.png)
...
![](https://ask.qcloudimg.com/http-save/yehe-9887858/4839cd6c614ca72a5354312d91150b3a.png)
...
![](https://ask.qcloudimg.com/http-save/yehe-9887858/280564ddb26d633e5fef83d993519e7b.png)
...
![](https://ask.qcloudimg.com/http-save/yehe-9887858/93d942fec75bccd506e3b316a7841cf1.jpeg)
...
![](https://ask.qcloudimg.com/http-save/yehe-9887858/e5f4dfb534d7eefd22aa66c0b1eee0ea.jpeg)
...
![](https://ask.qcloudimg.com/http-save/yehe-9887858/1c7a801d7b2c4bb01f72b83359471cd7.png)

**六、线程池的5种状态**

线程池内部有5个常量来代表线程池的五种状态

![](https://ask.qcloudimg.com/http-save/yehe-9887858/913b5ec4eac8d2f30bf50547d070acf7.png)
...
![](https://ask.qcloudimg.com/http-save/yehe-9887858/e4520dbdcbbdfc9b5bce6ffc41487b7b.png)
...
![](https://ask.qcloudimg.com/http-save/yehe-9887858/0fbe32a647507bf18d61224789347404.png)

就是将线程池的状态修改为SHUTDOWN，然后尝试打断空闲的线程（如何判断空闲，上面在说Worker继承AQS的时候说过），也就是在阻塞等待任务的线程。

shutdownNow方法

![](https://ask.qcloudimg.com/http-save/yehe-9887858/232d95d5d26b2e9b2e5c6235b0a3827a.png)
...
![](https://ask.qcloudimg.com/http-save/yehe-9887858/1887d4fb1d0cd4acc227038c7707a23b.png)

‍2）单个线程数量的线程池

![](https://ask.qcloudimg.com/http-save/yehe-9887858/f68818d7bc87ad524fd23a4f7c45027d.png)

‍3）接近无限大线程数量的线程池

![](https://ask.qcloudimg.com/http-save/yehe-9887858/3abb8527acbfaaa476bf4a193f7373db.png)

‍4）带定时调度功能的线程池

![](https://ask.qcloudimg.com/http-save/yehe-9887858/cebcc4f0e2bccd88c250a9a67ab8e616.png)
...
java中用来获取CPU核心数的方法是：Runtime.getRuntime().availableProcessors(); 2）线程工厂
...
本文转自 <https://cloud.tencent.com/developer/article/2058544>，如有侵权，请联系删除。